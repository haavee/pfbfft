...
import numpy
s = numpy.load('vlbi_J0530+1331_m011v_scan09_digi_1519311312.npy')

#sigproc.dbbc(200, 800e6, 64e6, s)
#sigproc.dbbc(23e6, 800e6, 16e6, s)
(l, u) = sigproc.dbbc(userinput.lo, 1712e6, 2*userinput.bw, s)
sigproc.wr_vdif(l, "/tmp/lsb.vdif")
sigproc.wr_vdif(u, "/tmp/usb.vdif")
plt.show()
